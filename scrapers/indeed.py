...
def scraper_indeed(poste="data scientist", lieu="France"):
    print(f"🔍 Démarrage JSearch API : {poste} - {lieu}")
        ...
        try:
            ...
            for job in jobs:
                offres.append({
                    ...
                    "salaire_min": job.get("job_min_salary") or None,
                    "salaire_max": job.get("job_max_salary") or None,
    ...
    if offres:
        ...
        chemin = "/opt/airflow/data/offres_indeed.csv"
...
if __name__ == "__main__":
    offres = scraper_indeed("data scientist", "France")
